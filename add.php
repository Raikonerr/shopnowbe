...
if(isset($_POST['save'])){
    ...
    if($mysqli_query($con,"INSERT INTO product (Brand, Product_name, Reference, Price, Quantity)  VALUES ('$brand','$pn','$reference','$price','$quantity')")){ header("location: products.php?remarks=succes");
    }else{
        $e=mysqli_error($con);}
